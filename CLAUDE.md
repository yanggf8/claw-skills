...
bound can exceed it on any day. `cct` is the standing example: the reports were
generated by GitHub Actions `schedule:` (documented best effort — it delayed
during high load, measured +0.6…+1.1 h normally and **+10.1 h** on 2026-08-28)
and read by fixed UTC crons carrying a 3 h buffer, so 2026-09-01's +4.3 h drift
